...
function connect_42 {
  ...
  while true ; do
    ...
    sshpid=$!
    java -server -Xmx512m -XX:+UseCompressedOops -jar agent.jar -jnlpUrl https://jogamp.org/chuck/computer/androidX86-jogamp-i686-sgothel-042/slave-agent.jnlp
  done
}
...
connect_42 > androidX86-jogamp-i686-sgothel-042.log 2>&1 &
disown $!
